...
parser.add_argument(
    '--head_name', default='fusion', choices=HEAD_CHOICES,
...
parser.add_argument(
    '--metric', default='euclidean', choices=loss_m.cdist.supported_metrics,
    help='Which metric to use for the distance between embeddings.')

parser.add_argument(
    '--loss', default='merged_loss', choices=loss_m.LOSS_CHOICES.keys(),
